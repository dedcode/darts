...
//           <span
//             className={
//               'py-1 px-4 ml-4 text-sm font-semibold tracking-widest rounded-full cursor-pointer transition duration-200 ease-in-out bg-teal-100 text-teal-700 hover:bg-teal-200 dk:bg-blue-900 dk:text-teal-100 dk-hover:bg-blue-700'
//             }
//           >
//             {tag}
//           </span>
