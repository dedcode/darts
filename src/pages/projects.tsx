          ...
          <div className="shadow-md rounded-lg hover:shadow-xl transition-shadow duration-300">
            <div className="flex items-center justify-center">
              ...
              <div className="flex flex-col ml-6 px-6 pt-4 w-11/12 md:w-2/3">
                <h2 className="mt-0">
                  <TextLink href="https://rxverisure.com/">RxVeriSure</TextLink>
                </h2>
                <p>
          ...
          <div className="shadow-md rounded-lg hover:shadow-xl transition-shadow duration-300">
            <div className="flex items-center justify-center">
              ...
              <div className="flex flex-col ml-6 px-6 pt-4 w-11/12 md:w-2/3">
                ...
                <p>
                  This project was developed for the organization Conference on
                  Crimes Against Women by my partner and I over the course of
                  about 3 months. The stakeholder requested that we develop an
                  application that streamlines the process of potential speakers
                  providing their information, submitting presentation
                  proposals, and uploading necessary documents, while allowing
                  the administrators to manage the schedule, speakers, and
...
export const query = graphql`
  query Projects {
    rxverisure: file(absolutePath: { regex: "/rxverisure.png/" }) {
      childImageSharp {
        fluid {
    ...
    ccaw: file(absolutePath: { regex: "/ccaw.png/" }) {
      childImageSharp {
        fluid {
          ...GatsbyImageSharpFluid
        }
