...
For this blog, I currently use markdown files to stash my posts right in my [github repository](https://github.com/Daynil/dlibin-nextjs/tree/master/src/content/posts). Whenever I add a post, Gatsby builds the blog posts into pages, and everything gets pushed and updated on my Netlify account.
